...
import {verifyAccessToken, verifyRefreshToken} from "@mock/data/user/processors.ts";

export const handlers = [
  // Login user
  http.post(`${import.meta.env.VITE_API_DOMAIN}/${apiEndpoints.API_LOGIN.url}`, () => {
  ...
  http.post(`${import.meta.env.VITE_API_DOMAIN}/${apiEndpoints.API_INIT_FLAGS.url}`, ({ request }) => {
